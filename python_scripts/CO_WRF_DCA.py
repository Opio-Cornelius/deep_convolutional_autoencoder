...
#Create data frame
d_co = pd.DataFrame({'month':['Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan',
                              'Feb', 'Mar', 'Apr', 'May'],
                     'MOPITT':[june_obs, july_obs, aug_obs, sep_obs, oct_obs, nov_obs,
                               dec_obs, jan_obs, feb_obs, mar_obs, apr_obs, may_obs],
                     'MOPITT_std':[june_std, july_std, aug_std, sep_std, oct_std, nov_std, 
                                   dec_std, jan_std, feb_std, mar_std, apr_std, may_std],
                     'WRF-Chem':[june_model, july_model, aug_model, sep_model, oct_model, 
                                 nov_model, dec_model, jan_model, feb_model, mar_model, apr_model, 
                                 may_model],
                     'WRF-Chem_std':[june_model_std, july_model_std, aug_model_std, sep_model_std, 
                                     oct_model_std, nov_model_std, dec_model_std, jan_model_std, 
                                     feb_model_std, mar_model_std, apr_model_std, may_model_std],
                     'WRF-DCA':[june_dca, july_dca, aug_dca, sep_dca, oct_dca, nov_dca, dec_dca, 
                                jan_dca, feb_dca, mar_dca, apr_dca, may_dca],
                     'WRF-DCA_std':[june_dca_std, july_dca_std, aug_dca_std, sep_dca_std, oct_dca_std, 
                                    nov_dca_std, dec_dca_std, jan_dca_std, feb_dca_std, mar_dca_std, 
                                    apr_dca_std, may_dca_std],
                     'WRF-LS':[june_ls, july_ls, aug_ls, sep_ls, oct_ls, nov_ls, dec_ls, jan_ls, 
                               feb_ls, mar_ls, apr_ls, may_ls],
                     'WRF-LS_std':[june_ls_std, july_ls_std, aug_ls_std, sep_ls_std, oct_ls_std, 
                                   nov_ls_std, dec_ls_std, jan_ls_std, feb_ls_std, mar_ls_std, 
                                   apr_ls_std, may_ls_std]})
...
d_bias = pd.DataFrame({'month':['Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan',
                              'Feb', 'Mar', 'Apr', 'May'],
                       'WRF-Chem':[NMB_june, NMB_july, NMB_aug, NMB_sep, NMB_oct, NMB_nov, NMB_dec,
                                   NMB_jan, NMB_feb, NMB_mar, NMB_apr, NMB_may],
                       'WRF-DCA':[NMB_dca_june, NMB_dca_july, NMB_dca_aug, NMB_dca_sep, NMB_dca_oct, NMB_dca_nov, 
                                  NMB_dca_dec, NMB_dca_jan, NMB_dca_feb, NMB_dca_mar, NMB_dca_apr, 
                                  NMB_dca_may],
                       'WRF-LS':[NMB_ls_june, NMB_ls_july, NMB_ls_aug, NMB_ls_sep, NMB_ls_oct, NMB_ls_nov, NMB_ls_dec, 
                                 NMB_ls_jan, NMB_ls_feb, NMB_ls_mar, NMB_ls_apr, NMB_ls_may]}) 
...
#Create data frame for rmse
d_rmse = pd.DataFrame({'month':['Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan',
                              'Feb', 'Mar', 'Apr', 'May'],
                       'WRF-Chem':[RMSE_june, RMSE_july, RMSE_aug, RMSE_sep, RMSE_oct, RMSE_nov, RMSE_dec,
                                   RMSE_jan, RMSE_feb, RMSE_mar, RMSE_apr, RMSE_may],
                       'WRF-DCA':[RMSE_dca_june, RMSE_dca_july, RMSE_dca_aug, RMSE_dca_sep, RMSE_dca_oct, RMSE_dca_nov, 
                                  RMSE_dca_dec, RMSE_dca_jan, RMSE_dca_feb, RMSE_dca_mar, RMSE_dca_apr, 
                                  RMSE_dca_may],
                       'WRF-LS':[RMSE_ls_june, RMSE_ls_july, RMSE_ls_aug, RMSE_ls_sep, RMSE_ls_oct, RMSE_ls_nov, RMSE_ls_dec, 
                                 RMSE_ls_jan, RMSE_ls_feb, RMSE_ls_mar, RMSE_ls_apr, RMSE_ls_may]})
